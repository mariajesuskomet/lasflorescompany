...
<div
  ...
  className={[
    ...
    'border-[#CEDBE8] border-t-[4px] border-[#789D00]', // ← borde superior verde
    withShadow ? 'shadow-[0_0_1px_rgba(9,30,66,0.31)]' : 'shadow-none',
  ].join(' ')}
>
  <div className="mx-auto w-full max-w-[1404px] px-6 py-4 flex items-center justify-between">
    {/* Logo */}
    <Link href="/" className="relative h-8 w-[135px]">
      <Image
        ...
        sizes="(min-width:768px) 180px, 135px"
        priority
      />
    </Link>
